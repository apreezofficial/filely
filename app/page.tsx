...
export default function Home() {
      ...
      case 1:
        return (
          <div style={{ textAlign: 'center', padding: '3rem 0' }}>
            <div className="spinner" style={{ width: '40px', height: '40px', border: '3px solid var(--border)', borderTopColor: 'var(--primary)', borderRadius: '50%', margin: '0 auto 1.5rem auto' }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            <div>
              ...
              <div style={{ background: 'var(--background)', padding: '1.5rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontWeight: 700, marginBottom: '0.35rem', fontSize: '1.125rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{file?.name}</p>
                <p className="text-secondary" style={{ fontSize: '0.875rem', fontWeight: 500 }}>{(file!.size / (1024 * 1024)).toFixed(2)} MB • {file?.type || 'Unknown'}</p>
              </div>
            </div>
            <div>
      ...
      case 3:
        return (
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ maxWidth: '400px', margin: '0 auto', background: 'var(--background)', padding: '2rem', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)', textAlign: 'left' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                <span className="text-secondary" style={{ fontWeight: 500 }}>Storage Duration</span>
                <span style={{ fontWeight: 700 }}>{isLoggedIn ? 'Permanent' : '30 Days'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                <span className="text-secondary" style={{ fontWeight: 500 }}>Visibility</span>
                <span style={{ fontWeight: 700 }}>Public (with URL)</span>
              </div>
              <button
      ...
      case 4:
        return (
          <div style={{ textAlign: 'center' }}>
            ...
            <h2 style={{ marginBottom: '0.5rem' }}>Link Ready!</h2>
            <p className="text-secondary" style={{ marginBottom: '2rem', fontWeight: 500 }}>Your file has been deployed and is ready to share.</p>
  ...
  return (
    <div className="container" style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '5rem', gap: '2rem', flexWrap: 'wrap' }}>
